...
const CodexUploadPage = () => {
  ...
  // Example tag options
  const tagOptions = ['Brand Guidelines', 'Product Info', 'Messaging', 'Tone', 'Legal', 'Values'];
  
  const handleFileChange = (e) => {
    const selectedFile = e.target.files[0];
    if (selectedFile && selectedFile.size <= 20 * 1024 * 1024) { // 20MB max
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="mx-auto max-w-5xl px-4 py-4">
          <h1 className="text-2xl font-bold text-gray-900">Memory Loom — Codex Upload</h1>
          <p className="mt-1 text-sm text-gray-500">Upload brand documents to build your semantic memory layer</p>
        </div>
      </header>
        ...
        <div className="mx-auto max-w-5xl px-4 py-8">
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <div className="mb-6">
              ...
              <div className={`border-2 border-dashed rounded-lg p-6 ${file ? 'border-blue-400 bg-blue-50' : 'border-gray-300'}`}>
                {!file ? (
            ...
            {/* Title Input */}
            <div className="mb-6">
              <label htmlFor="title" className="block text-sm font-medium text-gray-700 mb-2">Codex Title</label>
              <input
                type="text"
                id="title"
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap items-center gap-2 mb-2">
                {tags.map((tag, index) => (
                  <span key={index} className="inline-flex items-center rounded-full bg-blue-100 px-3 py-1 text-sm text-blue-800">
                    {tag}
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-md">
              <h3 className="text-sm font-medium text-gray-700 mb-2">Pre-Upload Compliance Check</h3>
              ...
              {uploadStatus === 'success' ? (
                <>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Your document has been uploaded and is being processed. The semantic memory layer will be updated shortly.
                  </p>
                </>
              ) : (
                <>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    There was an error uploading your document. Please ensure you've provided all required information and try again.
                  </p>
                </>
              )}
              <div className="mt-4">
