...
import SignalMonitor from "./SignalMonitorDashboard";
import TriggerConfigurator from "./TriggerConfig";
  ...
  return (
    <div className="flex flex-col bg-gray-50 min-h-screen">
      ...
      <main className="flex-1 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="bg-white rounded-lg shadow p-6">
            <div
              ...
              onClick={() => navigate("/dashboard/journeylist")}
            >
              <div>
          ...
          <div
            ...
            onClick={() => navigate("/dashboard/triggerconfigurator")}
          >
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-gray-500">
                  Avg. Trigger Success Rate
                </p>
                <h2 className="text-3xl font-bold mt-1">
                  {kpiData.avgTriggerSuccessRate}%
                </h2>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-amber-700 text-sm">
                    2 journeys have drifted beyond threshold
                  </p>
                  <a
                    href="#"
                    className="text-amber-600 text-sm font-medium mt-1 inline-block hover:underline"
                  >
                    View in Journey Validator
                  </a>
                </div>
              </div>
            </div>
        ...
        {activeTab === "monitor" && <SignalMonitor />}
        {activeTab === "triggers" && <TriggerConfigurator />}
        {activeTab === "journeys" && <JourneyAnalyticsDashboard />}
      </main>
    </div>
  );
}
