...
const MemorySearchConsole = () => {
  ...
  const availableTags = ['Brand Voice', 'Product', 'Compliance', 'Campaign', 'Legal'];
  ...
  const mockMemoryData = [
    {
      ...
      definition: 'Our product delivers 30% more efficiency than competitors with proprietary technology.',
      context: 'Use this when discussing product benefits or comparing to alternatives.',
      confidence: 0.92,
    ...
    },
    {
      ...
      definition: 'We promise reliability, transparency, and continuous improvement.',
      context: 'Central to all customer communications and support interactions.',
      confidence: 0.87,
    ...
    },
    {
      ...
      definition: 'Results may vary. Product efficacy based on controlled studies.',
      context: 'Must be included in all promotional materials discussing product benefits.',
      confidence: 0.95,
    ...
    },
    {
      ...
      definition: 'Confident, innovative, approachable, but never arrogant or overly technical.',
  ...
  const performSearch = () => {
    ...
    setTimeout(() => {
      let results = mockMemoryData.filter(item => 
      ...
      if (confidenceFilter > 0) {
        results = results.filter(item => item.confidence >= confidenceFilter/100);
      }
    ...
    <div className="bg-gray-50 min-h-screen p-6">
      <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        <div className="bg-blue-700 text-white p-4">
          ...
          <p className="text-blue-100">Access brand knowledge and semantic memory</p>
        </div>
          ...
          <div className="mr-4 mb-2">
            ...
            <div className="mt-1 flex items-center">
              <input
                ...
                className="w-32"
              />
              <span className="ml-2 text-sm text-gray-600">{confidenceFilter}%</span>
            </div>
          </div>
          ...
          {searchResults.length > 0 ? (
              ...
              {searchResults.map(result => (
                <div key={result.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                  <div className="flex justify-between items-start">
                    <h3 className="text-lg font-semibold text-blue-700">{result.term}</h3>
                    <div className="flex items-center">
                      <span 
                        className={`text-xs px-2 py-1 rounded-full ${
                  ...
                  <div className="mt-3 text-sm text-gray-600">
                    ...
                    <p className="mt-1"><strong>Source:</strong> {result.source}</p>
                  </div>
            ...
            searchQuery.length >= 2 && (
              <div className="flex items-center justify-center p-8 text-gray-500 border rounded-lg">
                ...
                <span>No memory objects match your search criteria. Try broadening your search or using different terms.</span>
              </div>
            )
          )}
        </div>
      ...
      <div className="mt-4 text-sm text-gray-500 max-w-6xl mx-auto p-2">
        <p className="flex items-center">
          ...
          Memory Loom semantic search allows access to brand knowledge across your organization. 
          Results are shown with confidence scores that indicate reliability of the information.
        </p>
      </div>
    </div>
  );
